...
public class TextMeasureView extends View {
    ...
    private void measureText() {//Paint 画笔
        mPaint.getTextBounds(mText, 0, mText.length(), mTextBounds); // 这个得到的是相对于传入的x，y的坐标
        Log.i(TAG, "mTextBounds = " + mTextBounds + ",left = " + mTextBounds.left + ",top = " + mTextBounds.top + ",right = " + mTextBounds.right + ",bottom = " + mTextBounds.bottom);
...
//        public float top;
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        Log.i(TAG, "offsetx = " + offsetx + "，offsety = " + offsety + "，width = " + width + "，height = " + height);
...
//        canvas.drawLine(0, y, width, y, mLinePaint);
        ...
        // 绘制中心线
        mLinePaint.setPathEffect(new DashPathEffect(new float[]{15, 15}, 0));
